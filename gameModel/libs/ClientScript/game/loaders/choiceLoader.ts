...
const helicopterParkChoice1: ChoiceDescriptor = {
  ...
  title: createOrUpdateTranslation('helicopter_choice_1 title', undefined),
  description: createOrUpdateTranslation('helicopter_choice_1 description', undefined),
  activeAtStart: false,
  repeats: 1,
  durationDeltaSec: 0,
  parent: 'mapTemplate',
...
const helicopterParkChoice2: ChoiceDescriptor = {
  ...
  title: createOrUpdateTranslation('helicopter_choice_2 title', undefined),
  description: createOrUpdateTranslation('helicopter_choice_2 description', undefined),
  activeAtStart: false,
  repeats: 1,
  durationDeltaSec: 0,
  parent: 'mapTemplate',
...
const helicopterParkChoice3: ChoiceDescriptor = {
  ...
  title: createOrUpdateTranslation('helicopter_choice_3 title', undefined),
  description: createOrUpdateTranslation('helicopter_choice_3 description', undefined),
  activeAtStart: false,
  repeats: 1,
  durationDeltaSec: 0,
  parent: 'mapTemplate',
...
const pmaChoice1: ChoiceDescriptor = {
  ...
  activableType: 'choice',
  tag: 'pma_choice_1',
  title: createOrUpdateTranslation('pma_choice_1 title', undefined),
...
const pmaChoice2: ChoiceDescriptor = {
  ...
  activableType: 'choice',
  tag: 'pma_choice_2',
  title: createOrUpdateTranslation('pma_choice_2 title', undefined),
...
const pmaChoice3: ChoiceDescriptor = {
  ...
  activableType: 'choice',
  tag: 'pma_choice_3',
  title: createOrUpdateTranslation('pma_choice_3 title', undefined),
