...
const DFLT_ACTION_DURATION: Omit<Record<SkillLevel, number>, 'no_skill'> = {
  low_skill: DFLT_ACTION_DURATION_LOW,
  high_skill: DFLT_ACTION_DURATION_HIGH,
};
