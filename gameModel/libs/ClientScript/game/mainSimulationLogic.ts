...
function initActionTemplates(): Record<string, ActionTemplateBase> {
  ...
  const appointEVASAN = new AppointEvasanActionTemplate('appoint-EVASAN-title', 'appoint-EVASAN-desc', TimeSliceDuration, 'appoint-EVASAN-feedback', true, [SimFlag.PC_BUILT, SimFlag.ACS_ARRIVED, SimFlag.MCS_ARRIVED]);
