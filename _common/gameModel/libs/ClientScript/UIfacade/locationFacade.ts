...
import { LocationAccessibility, LocationAccessibilityKind } from '../game/common/events/defineMapObjectEvent';
 ...
 */
export function getAccessibleLocationsInfo(kind : LocationAccessibilityKind | 'anyKind'): LocationInfo[] {
